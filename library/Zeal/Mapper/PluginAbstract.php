...
abstract class Zeal_Mapper_PluginAbstract implements Zeal_Mapper_PluginInterface
{
    ...
    public function preDelete($object, $mapper)
    {

    }

    public function postDelete($object, $mapper)
    {
